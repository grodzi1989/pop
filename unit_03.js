...
function f13() {
    ...
    document.querySelector('.out-13').innerHTML = (typeof i_130);
}
...
function f14() {
    ...
    switch (s_143) {
        case '-':
            document.querySelector('.out-14').innerHTML = i_141 - i_142;
            break;
        case '+':
            document.querySelector('.out-14').innerHTML = +i_141 + +i_142;
            break;
...
function f15() {
    ...
    if (s_153 == '||') {
        document.querySelector('.out-15').innerHTML = +s_151 || +s_152;
    }
    else {
        document.querySelector('.out-15').innerHTML = +s_151 && +s_152;
    }
